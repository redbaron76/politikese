...
jQuery.tableDnD = {
    ...
    makeDraggable: function(table) {
        ...
        jQuery(table).on('mousedown', 'tr', function(ev) {
            var $this = $(this);
        ...
        jQuery(table).find('tr').not('.nodrag').css("cursor", "move");
    ...
    mouseup: function(e) {
        if (jQuery.tableDnD.currentTable && jQuery.tableDnD.dragObject) {
            ...
            if (config.onDrop) {
                ...
                config.onDrop(jQuery.tableDnD.currentTable, droppedRow, jQuery(droppedRow).data('id'));
            }
    ...
    serialize: function() {
        if (jQuery.tableDnD.currentTable) {
            ...
            for (var i=0; i<rows.length; i++) {
                ...
                // RED result += tableId + '[]=' + rows[i].id;
                // result += tableId + '[]=' + jQuery(rows[i]).data('id');
                result += jQuery(rows[i]).data('id');
            }
            return result;
        } else {
